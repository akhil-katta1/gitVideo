...
st.title = ("Phidata Video AI Summarizer")
st.header = ("Powered by Google 2.0 flash exp")
...
video_file = st.file_uploader("Choose a video file", type=["mp4", "mov", "avi"], help="Upload a video file to summarize")
